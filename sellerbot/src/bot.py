...
async def send_start(message: types.Message):
    ...
    button1 = InlineKeyboardButton("Отзывы", url="https://www.avito.ru/sankt-peterburg/predlozheniya_uslug/popolnenie_oldubil_ozan_papara_paramtl_2732429303#open-reviews-list")
